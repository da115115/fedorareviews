...
%global disable_long_double 0
%ifarch %{arm}
  %global disable_long_double 1
%endif
...
Release: 1%{?dist}
License: Boost
%global full_version %{name}-%{version}.cmake0
URL: http://denisarnaud.fedorapeople.org/boost/1.44.0/14
...
functions and objects to Python, and reversely, using no special
...
%if %{with tests}
  %global boost_testflags -DBUILD_TESTS="ALL"
%endif
...
%changelog
* Wed Jul 11 2010 Denis Arnaud <denis.arnaud_fedora@m4x.org> - 1.44.0-1
...
- (#122817: libboost_*.so symblic links missing)
