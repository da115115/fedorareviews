...
BOOST_DEPLIST=$(repoquery --source --releasever=rawhide --whatrequires boost\* --disablerepo=* --enablerepo=fedora | sort -u)
...
sort -u boost_deplist_pack.txt > boost_deplist_pack_uniq.txt
rm -f boost_deplist_pack.txt
