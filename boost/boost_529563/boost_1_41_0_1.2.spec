...
Obsoletes: boost-doc < 1.31.0
Obsoletes: boost-python < 1.31.0
...
%changelog
* Sat Jan 14 2010 Denis Arnaud <denis.arnaud_fedora@m4x.org> - 1.41.0-1.1
- Suppressed the sub-packages for the Boost header-only components
