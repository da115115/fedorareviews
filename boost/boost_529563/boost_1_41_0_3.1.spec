...
##
# Support for various MPI compilers (e.g., MPICH2, OpenMPI)
...
%changelog
* Thu Jan 28 2010 Denis Arnaud <denis.arnaud_fedora@m4x.org> - 1.41.0-3.1
- First attempt to comply with MPI packaging guidelines
