...
# Migrated the configure script and Makefile.in files to newer versions (for F14)
#Patch1:         gnash-088-fix-configure.patch.bz2
...
# Autotools (configure and Makefile.in)
#patch1 -p1 
...
%build
# Suppressed the --enable-docbook option, as no info file has been modified
# (and they thus have not to be regenerated)
%configure --disable-static --with-npapi-plugindir=%{_libdir}/mozilla/plugins \
  --enable-ghelp --enable-media=GST \
...
%changelog
* Sun Aug 29 2010 Denis Arnaud <denis.arnaud_fedora@m4x.org> - 1:0.8.8-4
- Suppressed the --enable-docbook option in the configure script

* Sun Aug 29 2010 Denis Arnaud <denis.arnaud_fedora@m4x.org> - 1:0.8.8-3
- Patched the configure scripts and Makefiles for F14
