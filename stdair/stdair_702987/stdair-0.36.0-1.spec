...
find . -type f -name '*.[hc]pp' -exec %{__chmod} -x {} \;
...
find $RPM_BUILD_ROOT%{_libexecdir}/%{name} -type f -name '*.sh' -exec %{__chmod} +x {} \;
...
%changelog
* Sat Jul 30 2011 Denis Arnaud <denis.arnaud_fedora@m4x.org> 0.36.0-1
- Upstream update
